...
<BODY>
	...
	<H2><font size="4"><span style="font-weight: 400">Thank you for your 
	interest in our collection. Your inquiries will be responded to within 24 
	hours.<br>
...
<INPUT NAME="success" TYPE="hidden" VALUE="http://www.anne-french.com/featured.htm">
...
<TR>
<TD><B>Phone Number </B>(Optional)</TD>
<TD><INPUT NAME="phone" TYPE="text" SIZE="35"><BR></TD>
</TR>
<TR>
<TD><B>Comments<br>
</B>(include artist/painting)</TD>
<TD><textarea rows="7" name="comments" cols="55">Hi, I'm interested in this painting ID number <?php echo $_GET['paintingid']; ?> </textarea><BR></TD>
</TR>
</TABLE>
<BR>
<BR>
